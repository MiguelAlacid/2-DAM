...
public class LogDept {
	...
	public static DefaultTableModel getListado(String sSql) throws Exception {
		...
		while (resultado.next()) {
			...
			for (int iContador = 1; iContador <= numCampos; iContador++) {
					aFila[0] = resultado.getString("MODELO");
					aFila[1] = String.valueOf(resultado.getInt("COLOR"));
					aFila[2] = String.valueOf(resultado.getInt("TALLA"));
					aFila[3] = String.valueOf(resultado.getFloat("PRECIO"));
					aFila[4] =String.valueOf(resultado.getInt("STOCK"));
